        ...
        <div className="bg_white">
            <div className='template_container'>
                ...
                <p>Highlight <strong>"Active Directory Domain Services</strong>
                    <br />Hit <strong>"Next"</strong>
                    <br />A prompt may come up warning the user that other services will need to be added along with the chosen role service or features
                    <br />Click <b>"Add Features"</b>
                    <br />Click <b>"Install"</b></p>
                <div className='image_with_caption'>
                    <ImageItem
                        src={ADDSServerRole}
                        text="Server Roles"
                ...
                <p>Click <b>"Promote this server to a domain controller"</b></p>
                <div className='image_with_caption'>
                    <ImageItem
                ...
                <p>Choose the radio button option <b>"Add a new forest"</b> and choose a root domain name
                <br />Then hit <b>"Next"</b></p>
                <div className='image_with_caption'>
                    <ImageItem
                        src={NewForest}
                ...
                <p>Create a password for the Directory Services Restore Mode (DSRM) and retype to confirm
                ...
                <p>Verify the NETBIOS domain name then click <b>"Next"</b>
                    <br />For the paths page also click <b>"Next"</b>
                    <br />For the Review Options page also click <b>"Next"</b>
                    <br />For the Prerequisites Check page click <b>"Install"</b>
                </p>
                <div className='image_with_caption'>
                    <ImageItem
                        src={PreReqCheck}
