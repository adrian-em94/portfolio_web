    ...
    return (
        <div className="bg_white">
            <div className='template_container'>
                <h1>Active Directory Account Creation
                    <br />Windows Server 2016
                </h1>

                <p>Open Server Manager {'>'} Tools {'>'} Active Directory Users and Computers
                    <br />On the left navigation pane, inside the domain find the users folder and highlight it</p>
                ...
                <p>Then click <b>"Action"</b> {'>'} New User</p>
                <div className='image_with_caption'>
                    <ImageItem
                        src={NewUser}
                        text="New User"
                ...
                <p>Add a password, then click <b>"Next"</b></p>
                <div className='image_with_caption'>
                    <ImageItem
                        src={AddPassword}
                        text="Add A Password"
